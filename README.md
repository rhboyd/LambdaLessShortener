...
This is a sample template for linkshortener - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name linkshortener --tail
```
...
```bash
aws cloudformation delete-stack --stack-name linkshortener
```
